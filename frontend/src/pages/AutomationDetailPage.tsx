        ...
        <div className="max-w-3xl mx-auto pb-10">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col gap-4">
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                    <div className="flex items-start justify-between gap-4 mb-4">
                        ...
                        <div className="flex items-center gap-3 flex-shrink-0">
                            <span className={`text-xs font-medium px-3 py-1 rounded-full ${isActive ? 'bg-[#e4faef] text-[#00b67a]' : 'bg-gray-100 text-gray-400'}`}>
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                    ...
                    <div className="flex items-center justify-between p-4 bg-[rgba(0,182,122,0.05)] border border-[rgba(0,182,122,0.15)] rounded-xl">
                        <div className="flex items-center gap-3">
                            <div className="w-9 h-9 rounded-lg bg-[rgba(0,182,122,0.1)] flex items-center justify-center">
                                <Zap size={16} className="text-[#00b67a]" />
                            </div>
                            <div>
                        ...
                        <p className="text-2xl font-bold text-[#00b67a]">{rule.executedCount ?? rule.executed_count ?? 0}</p>
                    </div>
                </div>
            </motion.div>
        </div>
