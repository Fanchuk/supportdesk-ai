...
export default function Header() {
  ...
  return (
    <>
      <header
        className="h-[80px] px-7 flex items-center gap-4"
      ...
      >
        ...
        <button
          ...
          className="flex items-center gap-2 bg-white/10 rounded-lg px-2 py-1 w-[277px] h-[36px] hover:bg-white/20 transition-colors"
        >
