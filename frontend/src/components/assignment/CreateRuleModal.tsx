...
import { createAssignmentRule } from '../../services/assignment'
...
export default function CreateRuleModal({ open, onClose }: Props) {
                ...
                <motion.div
                    ...
                    <motion.div
                        ...
                        <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100 dark:border-gray-800">
                            <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Create Assignment Rule</h2>
                        ...
                        <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-4">
                            ...
                            <div className="flex flex-col gap-1.5">
                                <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Assign to Team</label>
                                <select
                                    value={form.teamId}
