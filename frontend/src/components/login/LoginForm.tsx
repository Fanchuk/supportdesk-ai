    ...
    return (
        <div className="w-full max-w-[420px]">
            <div className="flex items-center gap-2 mb-10 lg:hidden">
                ...
                <span className="font-semibold text-lg text-gray-900">Ticket Support</span>
            </div>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
                <button className="h-11 border border-gray-200 rounded-lg flex items-center justify-center gap-2 text-sm text-gray-600 hover:bg-gray-50 transition-colors">
            ...
            <div className="mt-10 flex items-center justify-center gap-6">
                {['Privacy Policy', 'Terms of Service', 'Support'].map((l) => (
                    <button key={l} className="text-xs text-gray-400 hover:text-gray-600">{l}</button>
                ))}
            </div>
        </div>
    )
